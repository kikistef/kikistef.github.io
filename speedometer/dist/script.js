let motorSamplePath = 'MotorcycleEnginAC_1.mp3';
//535039_11894201-lq.mp3
// METER
...
document.addEventListener("DOMContentLoaded", function () {
  ...
  (function loop() {
    ...
    // Update engine sound
    if (source) {
      source.playbackRate.value = rpm / 900;
    }

    if (source2) {
      source2.playbackRate.value = speed / 10200;
    }
  ...
  function getData() {
    ...
    request.onload = function () {
      ...
      audioCtx.decodeAudioData(audioData, function (buffer) {
        ...
        source.loopEnd = 0.3635; // Tune this

        source2.loopStart = 2.105;
        source2.loopEnd = 0.850;
